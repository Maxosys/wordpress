...
Class Registernew Extends AjaxLoginNew 
{
	/**
	...
	{
		add_action   ( 'wp_ajax_nopriv_register_submit', array( &$this,'register_submitnew' ) );
		add_action   ( 'wp_ajax_register_submit', array( &$this,'register_submitnew' ) );
		add_shortcode( 'ajax_registernew', array( &$this, 'register_shortcodenew' ) );
	}
     ...
     * @param $is_ajax
     */
    public function register_submitnew( $login=null, $password=null, $email=null, $is_ajax=true )
	{
        if ( $is_ajax ) check_ajax_referer('register_submitnew','security');
	...
	public function register_shortcodenew()
	{
		load_template( plugin_dir_path( dirname( __FILE__ ) ) . 'views/register-formnew.php' );		
	}
}
new Registernew;
