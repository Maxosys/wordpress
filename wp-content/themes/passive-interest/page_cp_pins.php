		...
		<div class="container-fluid">
			<div class="row-fluid">
				...
				<div class="span4 usercp-wrapper usercp-pins">
					<div class="error-msg">
						<div class="alert">
						<strong>faefeafea<?php echo $mime; echo "<br>".var_dump($image); ?><?php _e('Invalid image file.', 'ipin'); ?></strong>
						</div>
					</div>
				</div>
				<div class="span4"></div>
	...
	<div class="row-fluid">
		...
		<div class="span4 usercp-wrapper usercp-pins">
			...
			<div id="bookmarklet" class="hero-unit">
				<h4><?php _e('PIF It Bookmarklet', 'ipin'); ?></h4>
				...
				<p><small><?php _e('Drag the orange button to your bookmarks/favorites toolbar.Then click to pin an image from any website. You can also pin videos from youtube.com and vimeo.com.<br><strong>Note:</strong> Not compatible with Internet Explorer.', 'ipin'); ?></small></p>
				<!--
				<br />
			...
			<div id="pinitbutton" class="hero-unit">
				<h4><?php _e('PIF It Button', 'ipin'); ?></h4>
