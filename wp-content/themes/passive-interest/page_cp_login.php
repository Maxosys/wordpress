	...
	<div class="row-fluid">
		...
		<div class="span4 usercp-wrapper hide">
			...
			<form name="loginform" id="loginform" action="<?php echo site_url('/wp-login.php'); ?>" method="post">
				...
				<input type="hidden" name="redirect_to" id="redirect_to" value="<?php if ($_GET['redirect_to']) { echo esc_attr($_GET['redirect_to']); } else { echo esc_attr(home_url('/login')); } ?>" />
                ...
                <?php do_shortcode('[GSFBLOGIN class="first_fb_signup_gs fb_reg" text="Login with Facebook"]'); ?>
                
                <?php do_shortcode('[GSTWLOGIN class="first_tw_signup_gs tw_reg" text="Login with Twitter"]'); ?>
