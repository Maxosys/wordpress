	...
	//*********************************************** END REPINS  ************************************************************
						...
						{						
							...
							for($j=0;$j<count($pid);$j++) {
								$qqq = "SELECT * FROM $wpdb->posts WHERE `ID` = '".$pid[$j]."' and post_date like '%".$seldate."%' and post_author!='".$user_id."' ";
