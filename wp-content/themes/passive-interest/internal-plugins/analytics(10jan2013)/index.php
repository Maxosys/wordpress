...
require_once(CONFIG_ANALYTICS_PATH."/classes/MostClicked.class.php"); 	 // The most clicked panel class
...
require_once(CONFIG_ANALYTICS_PATH."/classes/Graphs.class.php"); // The most recent panel class
