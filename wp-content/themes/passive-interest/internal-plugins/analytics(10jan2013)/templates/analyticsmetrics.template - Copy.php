...
// pins and pinners
	...
	$obj =  new Graphs();
	include_once('analytics-pin-pinners.php');
	include_once('analytics-repin-repinners.php');
?>
<?php
//exit;
...
<div class="pin_qus">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/qus.png" alt="img" border="0" title="Repins are the daily average number of times pins from your website were repinned on Pinterest. " /></a>
</div>
<div class="clear"></div>
<div class="pin_zero">
...
<div class="pin_qus">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/o_qus.png" alt="img" border="0" title="Repinners are the daily average number of people who repinned your pins. " /></a>
</div>
<div class="clear"></div>
<div class="pin_zero">
...
<div id="repins_repinners1" style="width:745px; height: 400px; margin: 0 auto"></div>
...
<div class="pin_qus">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/qus.png" alt="img" border="0" title="Impressions are the daily average number of times your pins appeared on Pinterest in the main feed, in search results, or on on boards." /></a>
</div>
<div class="clear"></div>
<div class="pin_zero">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/b_zero.png" alt="img" border="0" /></a>
...
<div class="pin_qus">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/o_qus.png" alt="img" border="0" title="Reach are the daily average number of people who saw your pins on Pinterest." /></a>
</div>
<div class="clear"></div>
<div class="pin_zero">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/o_zero.png" alt="img" border="0" /></a>
...
<div class="pin_qus">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/qus.png" alt="img" border="0" title="Clicks are the daily average number of clicks to your website that came from Pinterest. " /></a>
</div>
<div class="clear"></div>
<div class="pin_zero">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/b_zero.png" alt="img" border="0" /></a>
...
<div class="pin_qus">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/o_qus.png" alt="img" border="0" title="Visitors are the daily average number of people who visited your website from Pinterest." /></a>
</div>
<div class="clear"></div>
<div class="pin_zero">
<a href="#"><img src="<?php bloginfo('template_url');?>/internal-plugins/analytics/images/o_zero.png" alt="img" border="0" /></a>
