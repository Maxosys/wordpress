...
//contype  => website url
 ...
 if(isset($_REQUEST['contype']))
 {
	...
	$executefile = mysql_query($str);
	
	$executefiledata = mysql_fetch_assoc($executefile);
	...
	if($cntrows>0)
	{
		...
		//$z3='insert into wp_usermeta(user_id,meta_key,meta_value) values("'.$uid.'","url_verified","no")' ;
		//mysql_query($z3);
	}
	else
	{
                            ...
                            <tr>
                                <td background="" style="background-color:#f7f5f5;">
                                    <h1 style="font-family:georgia,serif;font-weight:normal;font-size:22px;line-height:21px;color:#211922 !important;text-shadow:0 1px 0 #FFFFFF;margin:0;padding:0 20px;">
                                                ...
                                                Hi, '.$executefiledata['display_name'].'
