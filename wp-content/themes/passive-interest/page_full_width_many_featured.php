<?php
/*
Template Name: Page full-wdith Many Featured
*/
?>
...
$featured2_url = base64_decode($featured2_url);
$featured2_embeded = '<img src="' . $featured2_url . '" />';
?>
			...
			<div class="row">
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class('post-wrapper'); ?>>
						<div class="h1-wrapper">
                        	<div class="thumbnail-wrapper-nospace"><?php echo the_post_thumbnail(array(1200,999999)); ?></div>
                            <div class="video-wrapper-nospace"><?php echo $video_embeded; ?></div>
                            <div class="second-featured-wrapper-nospace"><?php echo $featured2_embeded; ?></div>
						</div><!--end h1-wrapper-->
