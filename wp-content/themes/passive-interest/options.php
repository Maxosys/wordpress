...
if ($_GET['settings-updated'] && of_get_option('default_avatar') != '') {
	$image = wp_get_image_editor(of_get_option('default_avatar'));
...
} else if ($_GET['settings-updated'] && of_get_option('default_avatar') == '') {
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Allow Price Input', 'options_framework_theme'),
	...
	*/
	...
	$options[] = array(
		...
		<ol>
		<li>
		WP-Admin > Pages > All Pages<br />Do not change the permalink for these pages (Board Settings, Everything, Following, Login, Lost Your Password, Pins Settings, Popular, Register, Settings, Source)
		</li>
		<li>
