...
/*********************************************************************/
/*						Theme local plugins inclusions					 */
/*********************************************************************/

// Include featured video functions
require_once("custom/featured_video/featured_video.php");
// Include second featured image
require_once("custom/second_featured_image/second_featured_image.php");

/*********************************************************************/
/*						Theme local plugins inclusions					 */
/*********************************************************************/

// include the setup wizzard for people

require_once("internal-plugins/setup-wizzard/index.php");
require_once("internal-plugins/gssmlogin/index.php");
require_once("internal-plugins/analytics/index.php"); 
...
register_nav_menus( array(
							'frontpage_nav' => 'Frontpage Navigation'
							));

/*********************************************************************/
/*						Languages and top navigation				 */
/*********************************************************************/
...
require_once("custom/page_layout/page_layout_customizer.php");
...
function ipin_wp_title( $title, $sep ) {
	...
	if (is_search()) {
		return __('Search results for') . ' ' . get_search_query();
	}
